...
BWA_SHIM_CK_OPT(extend_tie_frac);
BWA_SHIM_CK_OPT(extend_csub);
BWA_SHIM_CK_OPT(extend_tie_floor);
...
BWA_SHIM_CK_OPT(bam_threads);
BWA_SHIM_CK_OPT(meth_mode);
BWA_SHIM_CK_OPT(meth_scoring);
BWA_SHIM_CK_OPT(meth_seed_prune);
